...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item dropdown"><a id="dropdownSubMenu1" href="#"
			...
			<ul aria-labelledby="dropdownSubMenu1"
				...
				<!-- Level two dropdown-->
				<li class="dropdown-submenu dropdown-hover"><a id="dropdownSubMenu2"
					...
					<ul aria-labelledby="dropdownSubMenu2"
						...
						<li class="dropdown-submenu"><a id="dropdownSubMenu3" href="#"
	...
	<ul class="navbar-nav ml-auto">
		...
		<?php $notifications = Notification::find()->where(['!=','state_id', Notification::STATE_DELETED])->orderBy(['id'=>SORT_DESC])?>
		<a class="nav-link" data-toggle="dropdown" href="notification/index"> <i class="far fa-bell"></i> <span class="badge badge-warning navbar-badge"><?= $notifications->count() ?></span>
			...
			<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item">  
                  <i class="fas fa-<?=$notification->icon_name ?> btn btn-outline-primary btn-sm mr-1"></i> <?= $notification->title ?>  
                  <span class="float-right text-muted text-sm"><?= $notification->username ?></span>  
              </a>
              <?php } ?>
              </div>
<!--               <div class="dropdown-divider"></div>   -->
...
<!--               <a href="#" class="dropdown-item dropdown-footer">Clear All Notifications</a> 	 -->
            </div></li>
		<li class="nav-item">
